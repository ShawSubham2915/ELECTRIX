    ...
    <div className='fixed bg-slate-400 bg-opacity-35 w-full h-full top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            ...
            <div className='flex justify-between items-center bg-zinc-200 rounded-lg pb-3'>
                <h2 className='font-bold  text-lg  p-2 '>Edit Product</h2>
            ...
            <label htmlFor='sellingPrice' className='mt-3'>Selling Price :</label>
              ...
              >
                    ...
                    <button className='px-3 py-2 bg-slate-400 mb-10 hover:bg-slate-600 hover:text-white'>Update Product</button>
